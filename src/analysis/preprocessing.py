...
def main() -> None:
    ...
    parser.add_argument(
        ...
        # three .parent hops back up gets us to <repo_root>/data — matching the
        # original process_sessions.py default (data/ next to that repo-root script)
        # now that the code has moved.
